...
async def start(message):
    print('Привет.')
    await message.answer('Привет! Я бот помогающий твоему здоровью. Напиши слово calories и я рассчистаю количество'
                         ' клорий, которое тебе необходимо употреблять')
